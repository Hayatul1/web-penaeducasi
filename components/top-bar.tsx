...
export function TopBar() {
  ...
  return (
    <header
      ...
      "
    >
      <div className="mx-auto flex min-h-[64px] w-full max-w-[1400px] items-center justify-between pr-2 md:pr-4">
        ...
        <div className="flex min-w-0 flex-1 items-center">
          ...
          {/* 
            Mobile:
            pl-[64px] memberikan ruang untuk tombol hamburger
            yang berada di kiri atas.
            
            Desktop:
            md:pl-0 karena hamburger tidak ditampilkan.
          */}
          <div
            ref={scrollRef}
            className="
